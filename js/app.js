 ...
 let symbolsM = ['bicycle', 'bicycle', 'leaf', 'leaf', 'cube', 'cube', 'anchor', 'anchor',
 'paper-plane-o', 'paper-plane-o', 'bolt', 'bolt', 'bomb', 'bomb', 'diamond', 'diamond'];

 let symbolsE=['gift','gift','laptop','laptop'];

 let symbolsH=['twitter','twitter','youtube','youtube','linkedin','linkedin','android','android',
 'apple','apple','chrome','chrome','codepen','codepen','git','git','slack','slack','github','github',
 'hand-o-up','hand-o-up','hand-o-down','hand-o-down','hourglass-1','hourglass-1','hourglass-3','hourglass-3',
 'coffee','coffee','certificate','certificate','bug','bug','database','database'];
